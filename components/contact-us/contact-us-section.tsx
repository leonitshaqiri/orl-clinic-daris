...
export default function ContactUsSection() {
  return (
    <div className='w-11/12 mx-auto grid md:grid-cols-2 gap-x-10 px-5 md:px-10 xl:px-24 py-5 md:py-10 lg:py-12 border border-gray-400 rounded-4xl mt-20 mb-32'>
